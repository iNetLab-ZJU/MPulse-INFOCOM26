...
(
        ...
        #define STORE_MONITERED_ALIVE_REG_ACTION_N(n)\
            ...
            apply {
                ...
                GET_NEIGHBOR_ALIVE_REG_ACTION(0,1,6)

                GET_NEIGHBOR_ALIVE_REG_ACTION(1,2,6)
                    }else{
                    ...
                    if(reg_table_key_monitered==1){
                        ...
                        GET_NEIGHBOR_ALIVE_REG_ACTION(0, 11, 6);
                    }
                ...
                STORE_MONITERED_ALIVE_REG_ACTION_X(0,1,6)

                STORE_MONITERED_ALIVE_REG_ACTION_X(1,2,6)
                        }
                ...
                if(next_switch_reg_key==1){
                    ...
                    timeout_next_Switch2 =check_neighbor_time_1_reg_action.execute(6);
                }
                    ...
                    timeout_next_Switch2 =check_neighbor_time_2_reg_action.execute(6);
                }
              // }
