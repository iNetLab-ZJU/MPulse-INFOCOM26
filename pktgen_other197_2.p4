...
(
        ...
        #define STORE_MONITERED_ALIVE_REG_ACTION_N(n)\
            ...
            apply {
                ...
                GET_NEIGHBOR_ALIVE_REG_ACTION(0,5,2)

                GET_NEIGHBOR_ALIVE_REG_ACTION(1,6,2)
                    }else{
                    ...
                    if(reg_table_key_monitered==5){
                        ...
                        GET_NEIGHBOR_ALIVE_REG_ACTION(0, 11, 2);
                    }
                ...
                STORE_MONITERED_ALIVE_REG_ACTION_X(0,5,2)

                STORE_MONITERED_ALIVE_REG_ACTION_X(1,6,2)
                        }
                        ...
                        STORE_MONITERED_ALIVE_REG_ACTION_X(1 , 11 , 6);
                    }
                        // get_neighbor_id_and_state();
                        // reg_table_key_monitered= (reg_table_key_t) hdr.heartbeat.Monitored_switch;
                    }
                ...
                if(next_switch_reg_key==5){
                    ...
                    timeout_next_Switch2 =check_neighbor_time_5_reg_action.execute(2);
                }
                    ...
                    timeout_next_Switch2 =check_neighbor_time_6_reg_action.execute(2);
                }
              // }
