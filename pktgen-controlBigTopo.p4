...
// control registGet(inout headers hdr, 
//         inout ingress_metadata_t md,
//         in reg_table_key_t reg_table_key,
//         in Register<time_t, reg_table_key_t> remote_neighbor_time_reg,
//         in Register<reg_remote_state_t, reg_table_key_t> remote_neighbor_alive_reg,
//         in Register<reg_remote_state_t, reg_table_key_t> neighbor_time_reg,
//         in Register<register_state_t, reg_table_key_t> neighbor_alive_reg){
...
#define GEN_NEIGHBOR_STATE_REGISTER(n)  \    
    ...
    action get_neighbor_id_and_state(){
        ...
        state1=hdr.neighborState[0].state;
        state2=hdr.neighborState[1].state;
        state3=hdr.neighborState[3].state;
        state4=hdr.neighborState[4].state;
    }
