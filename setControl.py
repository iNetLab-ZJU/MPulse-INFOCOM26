...
def setFlow(bfrt_info, interface, ip):
    ...
    ###
    #To try action selector
    # catch_action__table = bfrt_info.table_get("pipe.SwitchIngress.catch_action_selector_ap")
    # catch_action_selector_table = bfrt_info.table_get("pipe.SwitchIngress.catch_action_selector")
    # catch_action__table.entry_add(
    #             target,
    #             [catch_action__table.make_key([gc.KeyTuple('$ACTION_MEMBER_ID',
    #                                                 eg_ports[port])])],
    #             [catch_action__table.make_data([gc.DataTuple('port', eg_ports[port])],
    #                                     'SwitchIngress.hit')])
        ...
        try:
            ...
            for digest in digestIter:
                ...
                for data in data_list:
                    ...
                    recv_port_0 = neighbor_graph_list[ip][recv_error_switch_0]
                    print(recv_port_0, recv_error_switch_0,recv_signature) if recv_error_switch_0 !=0
                    # recv_port_1 = data_dict["port_1"]
                    recv_error_switch_1 = data_dict["error_switch_1"]
                    recv_port_1 = neighbor_graph_list[ip][recv_error_switch_1]
                    print(recv_port_1, recv_error_switch_1,recv_signature) if recv_error_switch_1!=0                     # recv_port_2 = data_dict["port_2"]
                    recv_error_switch_2 = data_dict["error_switch_2"]
                    recv_port_2 = neighbor_graph_list[ip][recv_error_switch_2]
                    print(recv_port_2, recv_error_switch_2,recv_signature) if recv_error_switch_2!=0                     # recv_port_3 = data_dict["port_3"]
                    recv_error_switch_3 = data_dict["error_switch_3"]
                    recv_port_3 = neighbor_graph_list[ip][recv_error_switch_3]
                    print(recv_port_3, recv_error_switch_3,recv_signature) if recv_error_switch_3!=0                     # print(recv_port, recv_error_switch, recv_signature)
        except RuntimeError:
            pass
...
for x in ipList:
    ...
    check_digest_thread = threading.Thread(target=check_digest,args=(interface["192.168.123.103"],learn_filter,x,))
