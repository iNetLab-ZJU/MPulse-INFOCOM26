neighbor_graph_list = {
    # 11:{1:60,2:52,3:44,4:36,5:28,6:20,7:12,8:4,9:0,10:8},
                ...
                5:{1:140,2:148,11:164},
                6:{1:140,2:148,11:164}}
IP_SwitchCode={
    1: 196,
    2: 197,
    5: 194,
...
for switch_id in switch_id_recognition:
    ...
    for key in switch_id.keys() :
         if key.startswith('neighbor') :  
            ...
            STORE_MONITERED_ALIVE_REG_ACTION_X2.append("""
                        ...
                        STORE_MONITERED_ALIVE_REG_ACTION_X(%d , 11 , %d);
                    }"""
                         "" % (switch_id[key],switch_id[key],num,switch_id[key]))
            num+=1
    STORE_TEXT.append("""
        //todo:
        ...
        if key.startswith('neighbor'):
            ...
            if neighbor_num == '0':
                ...
                if(next_switch_reg_key==%d){
                    ...
                    timeout_next_Switch1 =check_neighbor_time_%d_reg_action.execute(11);
                    timeout_next_Switch2 =check_neighbor_time_%d_reg_action.execute(%d);
                }"""
                "" % (switch_id[key],switch_id[key],switch_id[key],switch_id[key],switch_id['SWITCH_NUM'])) 
            else:
                generated_text3.append("""
    ...
    with open(f"pktgen_other{IP_SwitchCode[switch_id['SWITCH_NUM']]}_{switch_id['SWITCH_NUM']}.p4", "w") as f:
        print("""%s"""
          "" % ('_'.join(switchNUM)),
        file=f)
        print("""(
        ...
        print("""     
                    ...
                    if(reg_table_key_monitered==11){
                        ...
                        GET_NEIGHBOR_ALIVE_REG_ACTION(0, 11, %d);
                    }
          ...
          "" % ('\n'.join(generated_text1),
                '\n'.join(GET_NEIGHBOR_ALIVE_REG_ACTION),
                '\n'.join(generated_text1),
                switch_id['SWITCH_NUM'],
                '\n'.join(STORE_MONITERED_ALIVE_REG_ACTION_X1),
